...
class MAADExperiment(ABC):
    def __init__(self, args, session_hash, training_experiment=False):
        """
        Abstract base class for different MAAD experiments for denoising, calibration and awareness estimation
        ...
        self.results_save_folder = os.path.join(os.path.expanduser("~"), "maad", "results")
