...
def create_maad_predictor(maad_predictor_input_dim_dict, predictor_output_size):
    return MAADPredictorNet(maad_predictor_input_dim_dict, predictor_output_size)


class MAADPredictorNet(torch.nn.Module):
    def __init__(self, maad_predictor_input_dim_dict, predictor_output_size):
        """
        Parameters:
        ----------
        maad_predictor_input_dim_dict: dict
        ...
        self.predictor_input_num_features = np.sum([x[0] for x in maad_predictor_input_dim_dict.values()])

        self.maad_predictor_input_dim_dict = maad_predictor_input_dim_dict
    ...
    def forward(self, predictor_input):
        ...
        predictor_input: torch.Tensor
            Output of the Fusion Net which will be fed into the MAADPredictorNet
