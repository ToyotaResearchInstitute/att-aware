...
from maad.model.EncoderNet import create_encoder
from maad.model.DecoderNet import create_decoder


def create_fusion_net(params_dict, network_out_height, network_out_width):
    """
    Helper function to create fusion net component of MAADNet
    ...
    # input to the maad predictor (more like the output size of the decoder that should match the input size of the maad predictor)
