...
def create_encoder(reduced_middle_layer_size=512, use_s3d=False):
    ...
    if not use_s3d:
        ...
        s3d_net["s3d_net_2"] = STConv3d(in_channels=256, out_channels=512, kernel_size=3, stride=1, padding=1,)
        s3d_net["s3d_net_3"] = STConv3d(
            in_channels=512, out_channels=s3d_layer_3_out_channels, kernel_size=3, stride=1, padding=1,
        )
...
class EncoderNet(torch.nn.Module):
    """
    Class for the Encoder Net in MAADNet
    """
